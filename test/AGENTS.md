...
- No e2e test currently bootstraps the app — the only `.e2e-spec.ts` left is a stub, despite `CLAUDE.md`'s testing conventions describing a full-bootstrap pattern.
